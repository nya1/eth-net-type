...
module.exports.getByGenBlockHash = function (blockHash) {
  ...
  var blockHashStr = '0x' + blockHash.toLowerCase().replace('0x', '')
  if (ethConst.blockHashList.indexOf(blockHashStr) > -1) {
    var chainRes = Object.assign(ethConst.chainInfo[blockHashStr], chainFound)
    return chainRes
